...
from tkinter import Canvas, Button, PhotoImage, Entry, END

OUTPUT_PATH = Path(__file__).parent
ASSETS_PATH = OUTPUT_PATH / Path(r"F:\Pemvis\New2\build\assets\frame1")
...
def on_button_click(input_text, text):
    if text.isdigit() or (text == "." and "." not in input_text.get()):
        ...
        input_text.delete(0, "end")
        input_text.insert(0, f"{kelvin:.2f}")
        input_text.insert("end", " K")
    elif text == "E":
        input_text.delete(0, "end")
...
def show_celsius(window):
    ...
    buttons = [
        ...
        ("button_15.png", "Back", (47.0, 167.0)),
        ("button_16.png", "6", (416.0, 713.0)),
        ("button_17.png", "8", (790.0, 713.0)),
        ("button_18.png", "9", (227.0, 544.0))
    ]
