...
ASSETS_PATH = OUTPUT_PATH / Path(r"F:\Pemvis\New2\build\assets\frame2")
...
def on_button_click(input_text, text):
    if text.isdigit() or (text == "." and "." not in input_text.get()):
        ...
        fahrenheit = float(input_text.get())
        ...
        input_text.delete(0, "end")
        input_text.insert(0, f"{reamur:.2f}°R")
...
def show_fahrenheit(window):
    ...
    buttons = [
        ...
        ("button_3.png", "konversi Celcius", (1381.0, 870.0)),
